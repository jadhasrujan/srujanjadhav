...
const commonClass =
  "input input-lg bg-transparent border-0 border-b-2 focus:outline-none focus:placeholder:text-picto-primary placeholder:text-[15px] md:placeholder:text-lg focus:border-picto-primary border-gray-200 dark:border-gray-700 w-full rounded-none px-0 text-gray-900 dark:text-white dark:placeholder:text-gray-500 transition-colors duration-300";

const Form = () => {
  return (
    <div>
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark dark:text-gray-400 transition-colors duration-300">
